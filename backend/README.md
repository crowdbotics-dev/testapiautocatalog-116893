...
## Project Structure
    ...
    ├── testapiautocatalog_116893  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116893`
...
2. Clone this repo and `cd testapiautocatalog_116893`
